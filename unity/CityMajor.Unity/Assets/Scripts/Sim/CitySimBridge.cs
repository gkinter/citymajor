...
namespace CityMajor.Sim
{
    ...
    public sealed class CitySimBridge : MonoBehaviour
    {
        ...
        static CitySimState CreatePlaceholderState() => new()
        {
            ...
            PoliceCoverageFraction = 0.55f,
            MeanCrimeRate = 0.18f,
            MeanSafetySatisfaction = 0.72f,
            WasteCoverageFraction = 0.48f,
            MeanPollution = 0.22f,
            MeanEnvironmentScore = 0.78f,
            LandfillUtilizationFraction = 0.42f,
            RecyclingDiversionRate = 0.35f,
            LandfillOverflowRate = 0.02f,
            SewageCoverageFraction = 0.52f,
            MeanWaterContamination = 0.2f,
            MeanWaterQuality = 0.8f,
            MeanPipeUtilization = 0.62f,
            CsoOverflowRate = 0.08f,
            StormRunoffLoad = 0.22f,
            InternetCoverageFraction = 0.58f,
            MeanInternetTier = 1.8f,
            MeanTelecomAccess = 0.6f,
        ...
        void PublishFromSimHost()
        {
            ...
            State = new CitySimState
            {
                ...
                PoliceCoverageFraction = snap.PoliceCoverageFraction,
                MeanCrimeRate = snap.MeanCrimeRate,
                MeanSafetySatisfaction = snap.MeanSafetySatisfaction,
                WasteCoverageFraction = snap.WasteCoverageFraction,
                MeanPollution = snap.MeanPollution,
                MeanEnvironmentScore = snap.MeanEnvironmentScore,
                LandfillUtilizationFraction = snap.LandfillUtilizationFraction,
                RecyclingDiversionRate = snap.RecyclingDiversionRate,
                LandfillOverflowRate = snap.LandfillOverflowRate,
                SewageCoverageFraction = snap.SewageCoverageFraction,
                MeanWaterContamination = snap.MeanWaterContamination,
                MeanWaterQuality = snap.MeanWaterQuality,
                MeanPipeUtilization = snap.MeanPipeUtilization,
                CsoOverflowRate = snap.CsoOverflowRate,
                StormRunoffLoad = snap.StormRunoffLoad,
                InternetCoverageFraction = snap.InternetCoverageFraction,
                MeanInternetTier = snap.MeanInternetTier,
                MeanTelecomAccess = snap.MeanTelecomAccess,
