...
export type BuildCatalogEntry = { typeId: number; name: string; category: BuildCategory; unlockKey?: string };
export const BUILD_TABS: { id: BuildCategory; label: string }[] = [
  { id: "civic", label: "Civic" }, { id: "education", label: "Education" },
  { id: "safety", label: "Safety" }, { id: "utilities", label: "Utilities" },
];
...
export function buildsForCategory(c: BuildCategory) { return BUILD_CATALOG.filter((e) => e.category === c); }
